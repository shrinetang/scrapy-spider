...
# ============================================================================
#    File: drug_info_single_v6.py
#
#    Desc: 修改了药品说明书和药品厂家带链接的抽取方式
#
# Version: 6.0
#    Date: 2015-6-10
#  Author: tangxingyu
...
class DrugSpider(CrawlSpider):  
    ...
    def parse_drug_search(self, response):
        ...
        for yps in yps_list:
            try:
                ...
                ymake = yps.xpath("div[@class='msgs']/p[2]/text()[2]|div[@class='msgs']/p[2]/a/text()").extract()
                ...
                if yattr:
                    ...
                    yps_dict['yattr'] = '-'
                if ymake:
                    ymake_str = ''.join(ymake)
                    yps_dict['ymake'] = ymake_str
                else:
                    yps_dict['ymake'] = '-'
                if ycomt:
    ...
    def parse_drug_manual(self, response):
        ...
        for fenlei in fenlei_list:
            try:
                ...
                list_value1  = fenlei.xpath("dd/p/text()|dd/p/a/text()").extract()
                list_value2  = fenlei.xpath("dd/text()|dd/a/text()").extract()
    ...
    def parse_drug_comment(self, response):
        ...
        #评价列表
        cmt_list = response.xpath("//div[@class='pls']/div[@class='pls_box']/div[@class='pls_mid']/p/text()").extract()
